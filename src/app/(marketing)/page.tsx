...
import { Brain, Zap, Trophy, Users, Star, Globe, Download, Bell, CheckCircle2 } from "lucide-react";
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col w-full bg-black">
          ...
          <div className="flex flex-col items-center lg:items-start gap-y-8 flex-1 z-10">
            ...
            <div className="flex flex-wrap gap-8 pt-4">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="text-sm text-gray-400">lenguas Vernaculas</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-3xl font-bold text-white">4.9★</div>
                <div className="text-sm text-gray-400">Valoraciones</div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section - AHORA EN NEGRO */}
      ...
      {/* Mobile Apps Coming Soon Section - AHORA EN NEGRO */}
        ...
        <div className="mx-auto max-w-7xl relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left px-2 sm:px-0">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-800 rounded-full text-emerald-300 text-xs sm:text-sm font-bold mb-4 sm:mb-6">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-400 mb-4 sm:mb-6 md:mb-8 max-w-2xl mx-auto lg:mx-0 px-2 sm:px-0">
              ...
              <div className="space-y-3 md:space-y-4 mb-8 md:mb-10 max-w-xl mx-auto lg:mx-0">
                <div className="flex items-start gap-3 text-left">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">{t("mobile.feature.offline")}</h4>
                    <p className="text-gray-400 text-sm">{t("mobile.feature.offline.desc")}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 text-left">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">{t("mobile.feature.notifications")}</h4>
                    <p className="text-gray-400 text-sm">{t("mobile.feature.notifications.desc")}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 text-left">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">{t("mobile.feature.sync")}</h4>
                    <p className="text-gray-400 text-sm">{t("mobile.feature.sync.desc")}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 text-left">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">{t("mobile.feature.voice")}</h4>
                    <p className="text-gray-400 text-sm">{t("mobile.feature.voice.desc")}</p>
                  </div>
                </div>
              </div>

              {/* App Store Badges (se mantienen igual, ya son oscuros) */}
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mb-6 md:mb-8 justify-center lg:justify-start w-full sm:w-auto">
                <button className="group flex items-center justify-center gap-2 md:gap-3 px-5 md:px-6 py-2.5 md:py-3 bg-gray-900 hover:bg-gray-800 text-white rounded-xl transition-all shadow-lg hover:shadow-xl w-full sm:w-auto border border-gray-800">
              ...
              {/* Early Access Form */}
              <div className="bg-gray-900/70 rounded-2xl p-4 sm:p-6 border border-gray-800 backdrop-blur-sm">
                <div className="flex items-center gap-2 mb-3">
                  <Download className="w-5 h-5 text-emerald-400 flex-shrink-0" />
                  <h3 className="font-bold text-white text-sm sm:text-base">{t("mobile.early.title")}</h3>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 sm:py-3 rounded-xl bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-900 outline-none transition-all text-sm sm:text-base"
                  />
            ...
            {/* Mobile-friendly icon display (solo móvil) */}
            <div className="order-1 md:hidden mb-8">
              <div className="flex justify-center gap-6">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-xs font-semibold text-gray-400">iOS</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-teal-600 to-emerald-600 flex items-center justify-center shadow-lg">
                    <svg viewBox="0 0 24 24" className="w-8 h-8 fill-white">
                      <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.5,12.92 20.16,13.19L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                    </svg>
                  </div>
                  <span className="text-xs font-semibold text-gray-400">Android</span>
                </div>
              </div>
            </div>

            {/* Right side - Phone Mockups (escritorio) */}
            <div className="order-1 lg:order-2 relative hidden md:flex md:justify-center lg:justify-end">
              <div className="relative w-64 lg:w-72">
                {/* Decoración */}
                <div className="absolute -top-20 -right-20 w-80 h-80 bg-gradient-to-br from-emerald-800 to-teal-800 rounded-full opacity-20 blur-3xl" />
                <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-gradient-to-br from-teal-800 to-emerald-800 rounded-full opacity-20 blur-3xl" />
                
                {/* Phone Mockup - ajustado a modo oscuro */}
                <div className="relative z-10 transform hover:scale-105 transition-transform duration-300">
                  <div className="relative w-full aspect-[9/19.5] bg-gray-900 rounded-[2.5rem] p-2 shadow-2xl border border-gray-800">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-4 bg-gray-900 rounded-b-2xl z-10" />
                    
                    {/* Screen (fondo oscuro) */}
                    <div className="relative w-full h-full bg-gray-950 rounded-[2.2rem] overflow-hidden">
                      <div className="absolute top-0 left-0 right-0 h-8 flex items-center justify-between px-4 pt-1">
                        <span className="text-gray-300 text-[10px] font-semibold">9:41</span>
                      ...
                      <div className="pt-8 p-4">
                        <div className="flex items-center gap-2 mb-4">
                          ...
                          <div>
                            <h3 className="text-sm font-bold text-white">Mbolo</h3>
                            <p className="text-[10px] text-gray-400">Aprende lenguas vernaculas</p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="bg-gray-800 rounded-lg p-3 border border-gray-700">
                            <div className="flex items-center justify-between mb-2">
                              <div className="flex items-center gap-2">
                                <span className="text-lg text-gray-300">FA</span>
                                <span className="text-xs font-semibold text-white">Fang</span>
                              </div>
                              <span className="text-[10px] text-emerald-400 font-medium">Saludos-Meberan</span>
                            </div>
                            <div className="space-y-1">
                              <div className="h-1.5 bg-gray-700 rounded-full overflow-hidden">
                                <div className="h-full bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full" style={{width: '65%'}} />
                              </div>
                              <span className="text-[9px] text-gray-400">65% Completo</span>
                            </div>
                          </div>
                          ...
                          <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-800">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <span className="text-lg text-gray-500">BU</span>
                                <div>
                                  <span className="text-xs font-medium text-white">Bubi</span>
                          ...
                          <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-800">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <span className="text-lg text-gray-500">ND</span>
                                <div>
                                  <span className="text-xs font-medium text-white">Ndowe</span>
                                  <span className="block text-[9px] text-gray-500">Saludos</span>
                                </div>
                              </div>
                              <div className="w-5 h-5 rounded-full border-2 border-gray-600 flex items-center justify-center">
                        ...
                        <div className="absolute bottom-4 left-4 right-4 bg-gray-800 rounded-xl p-2.5 shadow-lg border border-gray-700">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="w-7 h-7 bg-yellow-900/50 rounded-lg flex items-center justify-center">
                                <Trophy className="w-4 h-4 text-yellow-500" />
                              </div>
                              <div>
                                <div className="text-xs font-bold text-white">Racha de 7 dias seguidos</div>
                                <div className="text-[9px] text-gray-400">Sigue asi 🔥</div>
                              </div>
                            </div>
      ...
      {/* CTA Section - AHORA EN NEGRO CON GRADIENTE SUTIL */}
          ...
          <ClerkLoaded>
            <SignedOut>
              ...
              >
                <Button 
                  size="lg" 
                  className="text-lg px-10 h-14 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white shadow-xl hover:shadow-2xl transition-all border-0"
                >
                  {t("hero.cta.primary")}
                </Button>
              </SignUpButton>
